(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const n of t)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function e(t){const n={};return t.integrity&&(n.integrity=t.integrity),t.referrerPolicy&&(n.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?n.credentials="include":t.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(t){if(t.ep)return;t.ep=!0;const n=e(t);fetch(t.href,n)}})();const x="modulepreload",h=function(a){return"/"+a},b={},u=function(o,e,s){let t=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),d=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));t=Promise.allSettled(e.map(c=>{if(c=h(c),c in b)return;b[c]=!0;const p=c.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${m}`))return;const i=document.createElement("link");if(i.rel=p?"stylesheet":x,p||(i.as="script"),i.crossOrigin="",i.href=c,d&&i.setAttribute("nonce",d),document.head.appendChild(i),p)return new Promise((v,f)=>{i.addEventListener("load",v),i.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(r){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=r,window.dispatchEvent(d),!d.defaultPrevented)throw r}return t.then(r=>{for(const d of r||[])d.status==="rejected"&&n(d.reason);return o().catch(n)})};let l=null;const y={"/":{render:w,bindEvents:B},"/qr-gen":{render:E,bindEvents:k},"/mqtt-config":{render:I,bindEvents:T},"/form":{render:_,bindEvents:C}};window.addEventListener("hashchange",g);g();function g(){const a=location.hash.slice(1)||"/";if(a==="/form"&&!l){location.hash="/";return}const o=y[a]||y["/"];document.getElementById("app").innerHTML=o.render(),typeof o.bindEvents=="function"&&o.bindEvents();const e=document.getElementById("bottom-nav");e&&e.classList.toggle("hidden",a==="/form")}function w(){return`
  ...
  `}async function _(){const{getDraft:a,deleteDraft:o}=await u(async()=>{const{getDraft:n,deleteDraft:r}=await import("./db-C3AG-Uqc.js");return{getDraft:n,deleteDraft:r}},[]);let e=await a();e!=null&&e.formData&&(confirm("检测到未提交草稿，是否恢复？")?l={...l,...e.formData}:await o());const s=l.type==="设备类异常",{escapeHtml:t}=await u(async()=>{const{escapeHtml:n}=await import("./utils-VTbPu1Wo.js");return{escapeHtml:n}},[]);return`
    <div class="p-4 pt-6 max-w-md mx-auto">
      <h2 class="text-xl font-bold mb-4 text-center">异常提报</h2>
      <div class="bg-gray-50 rounded-xl p-4 mb-5 space-y-3">
        <div><span class="text-gray-500 text-sm">产品</span><div class="font-medium">${t(l.product)}</div></div>
        <div><span class="text-gray-500 text-sm">产线</span><div class="font-medium">${t(l.line)}</div></div>
        <div><span class="text-gray-500 text-sm">工站</span><div class="font-medium">${t(l.station)}</div></div>
        <div><span class="text-gray-500 text-sm">异常类型</span><div class="font-medium">${t(l.type)}</div></div>
        ${s?`
          <div><span class="text-gray-500 text-sm">设备名称</span><div class="font-medium">${t(l.deviceName||"N/A")}</div></div>
          <div><span class="text-gray-500 text-sm">资产编码</span><div class="font-medium">${t(l.assetCode||"N/A")}</div></div>
        `:""}
      </div>
      <div class="space-y-4">
